            ...
            <div id='hero-body' className="flex justify-center items-center mt-36 mb-44">
                <div>
                    <svg width="268" height="233" viewBox="0 0 268 233" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <rect x="209.228" y="181" width="22" height="34" rx="11" transform="rotate(45.4455 209.228 181)" fill="#F49000" />
                        <rect width="22" height="34" rx="11" transform="matrix(-0.701588 0.712583 0.712583 0.701588 85.4349 193)" fill="#F49000" />
                    </svg>
