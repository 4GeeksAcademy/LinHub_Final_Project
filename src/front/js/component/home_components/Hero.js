            ...
            <div id='hero-body' className="flex justify-center items-center mt-36 mb-44">
                <div>
                    <svg className='body' width="268" height="233" viewBox="0 0 268 233" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path className='pata' d="M82.0947 205.569C84.8977 201.369 90.5741 200.238 94.7733 203.041L105.397 210.132C109.596 212.935 110.728 218.611 107.925 222.81V222.81C105.122 227.009 99.4453 228.141 95.246 225.338L84.6228 218.247C80.4236 215.444 79.2917 209.768 82.0947 205.569V205.569Z" fill="#F49000" />
                        <path className='pata' d="M212.855 193.36C209.34 189.295 203.196 188.849 199.131 192.364L190.36 199.949C186.295 203.464 185.849 209.609 189.364 213.673V213.673C192.879 217.738 199.024 218.184 203.089 214.669L211.86 207.085C215.925 203.57 216.37 197.425 212.855 193.36V193.36Z" fill="#F49000" />
                    </svg>
