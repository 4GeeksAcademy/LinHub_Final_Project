        ...
        <>
            <div id='hero-body' className="flex justify-center items-center mt-36 mb-44">
                ...
                <div id='hero' className='d-flex flex-column'  >
                    ...
                    <div className='mt-16'>
                        <button id='boton-hero' type="button" className="block m-auto text-center m-0 p-0 h-14 rounded-xl border-0 w-96">
                            <Link to='/signup'>
                                <strong className='py-2'>{currentIdiom === 'Español' ? '¡Empieza ahora!' : 'Start now!'}</strong>
                            </Link>
                        </button>
                        <button id='boton-hero2' type="button" className="block m-auto text-purple-500 text-center mt-2 p-0 h-14 rounded-xl border-b-0 border-2 border-slate-200 w-96">
                            <Link to='/login'>
