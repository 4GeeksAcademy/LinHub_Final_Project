...
const SectionShowOne = () => {
    ...
    return (
        <>
            <div className='barrita' > hola</div>
            <div className='flex flex-row justify-center items-center py-4 mt-20'>
                ...
                <svg width="178" height="280" viewBox="0 0 178 280" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="2.5" y="2.5" width="173" height="275" rx="23.5" fill="white" stroke="#FF9600" stroke-width="5" />
                    <rect className='barrita' x="26" y="39" width="125" height="9" rx="4.5" fill="#EBEBEB" />
