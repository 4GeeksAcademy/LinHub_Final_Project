...
const SectionShowOne = () => {
    ...
    return (
        <>
            <div className='container flex flex-row justify-around items-center py-4 mt-20'>
                ...
                <img className='flex-initial w-30' src='https://raw.githubusercontent.com/4GeeksAcademy/LinHub_Final_Project/main/src/front/img/sectionh_three.svg' width="250px" />
            </div>
        </>
    )
}
