...
const SectionShowOne = () => {
    ...
    return (
        <>
            <div className='flex flex-col-reverse sm:flex-row justify-center items-center py-4 mt-20'>
                {store.currentIdiom === 'Español' ? (
                    <div className='flex-initial w-1/2 align-middle'>
                        <h1 className='text-violet-500 text-3xl sm:text-6xl mb-8 font-bold'>Divertido, Interactivo y gratis</h1>
                    ...
                    <div className='flex-initial w-1/2 align-middle'>
                        <h1 className='text-violet-500 text-3xl sm:text-6xl mb-8 font-bold'>Fun, Interactive, and Free</h1>
