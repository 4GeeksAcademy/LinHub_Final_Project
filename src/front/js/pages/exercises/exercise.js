...
export function Exercise() {
    ...
    const handleNext = async () => {
        try {
            ...
            setlinResponse("try it, dont surrender");
        }
        setTimeout(() => {
            setShowLin(false);
        }, 2000);
                    ...
                    <div className="exercise-smartphone">
                        <div className='screen'>
                            ...
                            <Stepper className='' activeStep={activeStep}>
                                ...
                                ShowLin ? <div className='exercise-lin flex flex-col-reverse mt-8 items-center'>
                                    <svg className='body my-8' width="201" height="175" viewBox="0 0 268 233" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'rotate(60deg)' }}>
                                    ...
                                    <div className='w-60 flex text-white justify-center items-center mt-8'>
                                        <div><h3 className='bg-indigo-500 p-2 rounded-full'>{linResponse}</h3></div>
                                    </div>
                                </div>
                                    :
